    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <span className="text-blue-600 font-bold text-xl">Company</span>
              </div>
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center">
              <button onClick={() => navigate('/login')} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium">
                Get Started
              </button>
            </div>
      ...
      <div className="relative bg-white overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Our platform helps you streamline operations, increase revenue, and deliver exceptional customer experiences.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-gray-100 flex items-center justify-center">
          <div className="h-64 w-full sm:h-72 md:h-96 lg:w-full lg:h-full p-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides all the tools you need to grow your business efficiently.
            </p>
          </div>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Real-time insights into your business performance with intuitive charts and reports.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Accept payments securely through multiple gateways with automated invoice generation.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg font-medium text-gray-900">Automation Tools</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Streamline workflows with powerful automation that saves time and reduces errors.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    24/7 support to help you resolve issues quickly and keep your business running smoothly.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
            ...
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                <div className="flex-1">
                  <p className="text-sm font-medium text-blue-600">CEO</p>
                  <div className="block mt-2">
                    <p className="text-xl font-semibold text-gray-900">Sarah Johnson</p>
                    <p className="mt-3 text-base text-gray-500">
                      "This platform has transformed how we operate. Our productivity has increased by 40% since we started using it."
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                <div className="flex-1">
                  <p className="text-sm font-medium text-blue-600">Marketing Director</p>
                  <div className="block mt-2">
                    <p className="text-xl font-semibold text-gray-900">David Chen</p>
                    <p className="mt-3 text-base text-gray-500">
                      "The analytics tools have given us insights we never had before. We've been able to optimize our campaigns for much better ROI."
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
              <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                <div className="flex-1">
                  <p className="text-sm font-medium text-blue-600">Small Business Owner</p>
                  <div className="block mt-2">
                    <p className="text-xl font-semibold text-gray-900">Lisa Rodriguez</p>
                    <p className="mt-3 text-base text-gray-500">
                      "As a small business, we needed something affordable but powerful. This solution exceeded our expectations on both fronts."
                    </p>
                  </div>
                </div>
              </div>
